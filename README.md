...
Testing
-------
Before testing, you should make sure that you have downloaded the pretrianed model. (Pretrained model can be downloaded in [model](https://pan.baidu.com/s/1Eu7EqUiw3H2ExkUOAXLeCg)) This example shows how to run a pretrained model using a single GPU for inference. 
```
