...
# SOFT prefix indicates that the computation is performed on soft masks
#   Valid options: ('SOFT_AVG', 'SOFT_MAX', 'LOGIT_AVG')
__C.TEST.UV_AUG.HEUR = b'SOFT_AVG'

# Horizontal flip at the original scale (id transform)
__C.TEST.UV_AUG.H_FLIP = False

# Each scale is the pixel size of an image's shortest side
__C.TEST.UV_AUG.SCALES = ()

# Max pixel size of the longer side
__C.TEST.UV_AUG.MAX_SIZE = 4000

# Horizontal flip at each scale
__C.TEST.UV_AUG.SCALE_H_FLIP = False

# Apply scaling based on object size
__C.TEST.UV_AUG.SCALE_SIZE_DEP = False
__C.TEST.UV_AUG.AREA_TH = 180**2

# Each aspect ratio is relative to image width
__C.TEST.UV_AUG.ASPECT_RATIOS = ()

# Horizontal flip at each aspect ratio
__C.TEST.UV_AUG.ASPECT_RATIO_H_FLIP = False
# ---------------------------------------------------------------------------- #
# Soft NMS
# ---------------------------------------------------------------------------- #
...
__C.MRCNN.DP_CASCADE_MASK_ON = False

# Binarization threshold for converting soft masks to hard masks
__C.MRCNN.THRESH_BINARIZE = 0.5
__C.MRCNN.USE_CLS_EMBS = False
__C.MRCNN.MAX_ROIS_PER_IM = 160
__C.MRCNN.BBOX_CASCADE_MASK_ON = False
__C.MRCNN.USE_KPS_CONV = False
# ---------------------------------------------------------------------------- #
...
__C.KRCNN.BBOX_CASCADE_KPT_ON = False
# ---------------------------------------------------------------------------- #
...
__C.BODY_UV_RCNN.MULTI_ROI = False
__C.BODY_UV_RCNN.MULTI_LEVEL_RES = [28,14,14,7]
__C.BODY_UV_RCNN.MULTI_LEVEL_FEAT = [2,3,4,5]
__C.BODY_UV_RCNN.INTERMEDIA_SUPER = False
__C.BODY_UV_RCNN.ONLY_PARTSEG = False
# Standard ROI XFORM options (see FAST_RCNN or MRCNN options)
...
__C.BODY_UV_RCNN.INTER_WEIGHTS = 0.1
# Train only with images that have body uv annotations
__C.BODY_UV_RCNN.BODY_UV_IMS = False

__C.BODY_UV_RCNN.USE_CLS_EMBS = False
__C.BODY_UV_RCNN.DP_CASCADE_MASK_ON = False
__C.BODY_UV_RCNN.SOFT_MASK_THRESH = 0.3
__C.BODY_UV_RCNN.USE_BOX_ALL_MASKS = False
__C.BODY_UV_RCNN.USE_AMA_NET = False
__C.BODY_UV_RCNN.NUM_BODY_PARTS = 14
# ---------------------------------------------------------------------------- #
# R-FCN options
# ---------------------------------------------------------------------------- #
__C.RFCN = AttrDict()
