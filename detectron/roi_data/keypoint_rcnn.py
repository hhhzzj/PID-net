...
def add_keypoint_rcnn_blobs(
    ...
    input_w = int(roidb['input_width'] / im_scale)
    input_h = int(roidb['input_height'] / im_scale)
    ...
    if cfg.KRCNN.BBOX_CASCADE_KPT_ON:
        heats, weights, proposal_heats = keypoint_utils.keypoints_to_global_heatmap_labels(
            sampled_keypoints, sampled_fg_rois, input_h, input_w
        )
    #    blobs['inter_keypoint_int32'] = proposal_heats
    else:
