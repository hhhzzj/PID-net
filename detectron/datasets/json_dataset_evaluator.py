...
# from detectron.datasets.densepose_cocoeval_chaallenge import denseposeCOCOeval
#
...
def evaluate_body_uv(
    ...
    if json_dataset.name.find('test') == -1:
        ...
        # print(res_json_file)
        # coco_eval = _do_body_uv_eval(json_dataset, res_json_file, output_dir)
